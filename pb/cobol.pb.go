...
var file_cobol_proto_msgTypes = make([]protoimpl.MessageInfo, 152)
var file_cobol_proto_goTypes = []interface{}{
	...
	(*AlphabetClause_Also)(nil),             // 171: pb.AlphabetClause.Also
	(*AlphabetClause_AlphabetLiteral)(nil),  // 172: pb.AlphabetClause.AlphabetLiteral
	(*AlphabetClause_AlphabetLiterals)(nil), // 173: pb.AlphabetClause.AlphabetLiterals
	(*AlphabetClause_Alphanumeric)(nil),     // 174: pb.AlphabetClause.Alphanumeric
	(*AlphabetClause_National)(nil),         // 175: pb.AlphabetClause.National
}
var file_cobol_proto_depIdxs = []int32{
	...
	174, // 48: pb.AlphabetClause.alphanumeric:type_name -> pb.AlphabetClause.Alphanumeric
	175, // 49: pb.AlphabetClause.national:type_name -> pb.AlphabetClause.National
	...
	141, // 100: pb.IoControlParagraph.file_name:type_name -> pb.FileName
	78,  // 101: pb.IoControlParagraph.commitment_control_clause:type_name -> pb.CommitmentControlClause
	76,  // 102: pb.IoControlParagraph.multiple_file_clause:type_name -> pb.MultipleFileClause
	71,  // 103: pb.IoControlParagraph.rerun_clause:type_name -> pb.RerunClause
	75,  // 104: pb.IoControlParagraph.same_clauses:type_name -> pb.SameClause
	132, // 105: pb.RerunClause.assignment_name:type_name -> pb.AssignmentName
	141, // 106: pb.RerunClause.file_name:type_name -> pb.FileName
	74,  // 107: pb.RerunClause.rerun_every_clock:type_name -> pb.RerunEveryClock
	73,  // 108: pb.RerunClause.rerun_every_of:type_name -> pb.RerunEveryOf
	72,  // 109: pb.RerunClause.rerun_every_records:type_name -> pb.RerunEveryRecords
	163, // 110: pb.RerunEveryRecords.records:type_name -> pb.IntegerLiteral
	13,  // 111: pb.RerunEveryOf.type:type_name -> pb.RerunEveryOf.Type
	141, // 112: pb.RerunEveryOf.file_name:type_name -> pb.FileName
	163, // 113: pb.RerunEveryClock.clock_units:type_name -> pb.IntegerLiteral
	141, // 114: pb.SameClause.file_names:type_name -> pb.FileName
	14,  // 115: pb.SameClause.form:type_name -> pb.SameClause.Form
	77,  // 116: pb.MultipleFileClause.multiple_file_positions:type_name -> pb.MultipleFilePosition
	163, // 117: pb.MultipleFilePosition.position:type_name -> pb.IntegerLiteral
	141, // 118: pb.MultipleFilePosition.file_name:type_name -> pb.FileName
	141, // 119: pb.CommitmentControlClause.file_name:type_name -> pb.FileName
	104, // 120: pb.DataDivision.communication_section:type_name -> pb.CommunicationSection
	106, // 121: pb.DataDivision.data_base_section:type_name -> pb.DataBaseSection
	80,  // 122: pb.DataDivision.file_section:type_name -> pb.FileSection
	103, // 123: pb.DataDivision.linkage_section:type_name -> pb.LinkageSection
	102, // 124: pb.DataDivision.local_storage_section:type_name -> pb.LocalStorageSection
	100, // 125: pb.DataDivision.program_library_section:type_name -> pb.ProgramLibrarySection
	98,  // 126: pb.DataDivision.report_section:type_name -> pb.ReportSection
	96,  // 127: pb.DataDivision.ScreenSection:type_name -> pb.ScreenSection
	94,  // 128: pb.DataDivision.working_storage_section:type_name -> pb.WorkingStorageSection
	81,  // 129: pb.FileSection.file_description_entries:type_name -> pb.FileDescriptionEntry
	15,  // 130: pb.FileDescriptionEntry.type:type_name -> pb.FileDescriptionEntry.Type
	141, // 131: pb.FileDescriptionEntry.file_name:type_name -> pb.FileName
	84,  // 132: pb.FileDescriptionEntry.block_contains_clause:type_name -> pb.BlockContainsClause
	92,  // 133: pb.FileDescriptionEntry.code_set_clause:type_name -> pb.CodeSetClause
	89,  // 134: pb.FileDescriptionEntry.data_records_clause:type_name -> pb.DataRecordsClause
	82,  // 135: pb.FileDescriptionEntry.external_clause:type_name -> pb.ExternalClause
	83,  // 136: pb.FileDescriptionEntry.global_clause:type_name -> pb.GlobalClause
	86,  // 137: pb.FileDescriptionEntry.label_records_clause:type_name -> pb.LabelRecordsClause
	91,  // 138: pb.FileDescriptionEntry.linage_clause:type_name -> pb.LinageClause
	85,  // 139: pb.FileDescriptionEntry.record_contains_clause:type_name -> pb.RecordContainsClause
	93,  // 140: pb.FileDescriptionEntry.report_clause:type_name -> pb.ReportClause
	87,  // 141: pb.FileDescriptionEntry.value_of_clause:type_name -> pb.ValueOfClause
	163, // 142: pb.BlockContainsClause.from:type_name -> pb.IntegerLiteral
	163, // 143: pb.BlockContainsClause.to:type_name -> pb.IntegerLiteral
	16,  // 144: pb.BlockContainsClause.unit:type_name -> pb.BlockContainsClause.Unit
	163, // 145: pb.RecordContainsClause.from:type_name -> pb.IntegerLiteral
	163, // 146: pb.RecordContainsClause.to:type_name -> pb.IntegerLiteral
	120, // 147: pb.RecordContainsClause.qualified_data_name:type_name -> pb.QualifiedDataName
	17,  // 148: pb.LabelRecordsClause.type:type_name -> pb.LabelRecordsClause.Type
	138, // 149: pb.LabelRecordsClause.data_names:type_name -> pb.DataName
	88,  // 150: pb.ValueOfClause.value_pairs:type_name -> pb.ValuePair
	156, // 151: pb.ValuePair.system_name:type_name -> pb.SystemName
	120, // 152: pb.ValuePair.qualified_data_name:type_name -> pb.QualifiedDataName
	160, // 153: pb.ValuePair.literal:type_name -> pb.Literal
	138, // 154: pb.DataRecordsClause.data_names:type_name -> pb.DataName
	138, // 155: pb.DataNameOrIntegerLiteral.data_name:type_name -> pb.DataName
	163, // 156: pb.DataNameOrIntegerLiteral.integer_literal:type_name -> pb.IntegerLiteral
	90,  // 157: pb.LinageClause.footing_at:type_name -> pb.DataNameOrIntegerLiteral
	90,  // 158: pb.LinageClause.lines_at_bottom:type_name -> pb.DataNameOrIntegerLiteral
	90,  // 159: pb.LinageClause.lines_at_top:type_name -> pb.DataNameOrIntegerLiteral
	90,  // 160: pb.LinageClause.number_of_lines:type_name -> pb.DataNameOrIntegerLiteral
	131, // 161: pb.CodeSetClause.alphabet_name:type_name -> pb.AlphabetName
	152, // 162: pb.ReportClause.report_names:type_name -> pb.ReportName
	18,  // 163: pb.WorkingStorageSection.container_type:type_name -> pb.DataDescriptionEntryContainer.Type
	18,  // 164: pb.DataDescriptionEntryContainer.type:type_name -> pb.DataDescriptionEntryContainer.Type
	97,  // 165: pb.ScreenSection.screen_description_entries:type_name -> pb.ScreenDescriptionEntry
	99,  // 166: pb.ReportSection.report_descriptions:type_name -> pb.ReportDescription
	101, // 167: pb.ProgramLibrarySection.library_description_entries:type_name -> pb.LibraryDescriptionEntry
	18,  // 168: pb.LocalStorageSection.container_type:type_name -> pb.DataDescriptionEntryContainer.Type
	19,  // 169: pb.LinkageSection.type:type_name -> pb.LinkageSection.Type
	105, // 170: pb.CommunicationSection.communication_description_entries:type_name -> pb.CommunicationDescriptionEntry
	20,  // 171: pb.CommunicationSection.type:type_name -> pb.CommunicationSection.Type
	107, // 172: pb.DataBaseSection.data_base_section_entries:type_name -> pb.DataBaseSectionEntry
	120, // 173: pb.Identifier.qualified_data_name:type_name -> pb.QualifiedDataName
	111, // 174: pb.Identifier.table_call:type_name -> pb.TableCall
	112, // 175: pb.Identifier.function_call:type_name -> pb.FunctionCall
	165, // 176: pb.Identifier.special_register:type_name -> pb.SpecialRegister
	120, // 177: pb.TableCall.qualified_data_name:type_name -> pb.QualifiedDataName
	116, // 178: pb.TableCall.subscripts:type_name -> pb.Subscript
	113, // 179: pb.TableCall.reference_modifier:type_name -> pb.ReferenceModifier
	142, // 180: pb.FunctionCall.function_name:type_name -> pb.FunctionName
	117, // 181: pb.FunctionCall.arguments:type_name -> pb.Argument
	113, // 182: pb.FunctionCall.reference_modifier:type_name -> pb.ReferenceModifier
	114, // 183: pb.ReferenceModifier.character_position:type_name -> pb.CharacterPosition
	115, // 184: pb.ReferenceModifier.length:type_name -> pb.Length
	109, // 185: pb.CharacterPosition.arithmetic_expression:type_name -> pb.ArithmeticExpression
	109, // 186: pb.Length.arithmetic_expression:type_name -> pb.ArithmeticExpression
	163, // 187: pb.Subscript.integer_literal:type_name -> pb.IntegerLiteral
	118, // 188: pb.Subscript.qualified_data_name:type_name -> pb.QualifiedDataNameIntegerLiteral
	119, // 189: pb.Subscript.index_name:type_name -> pb.IndexNameIntegerLiteral
	109, // 190: pb.Subscript.arithmetic_expression:type_name -> pb.ArithmeticExpression
	160, // 191: pb.Argument.literal:type_name -> pb.Literal
	110, // 192: pb.Argument.identifier:type_name -> pb.Identifier
	118, // 193: pb.Argument.qualified_data_name:type_name -> pb.QualifiedDataNameIntegerLiteral
	119, // 194: pb.Argument.index_name:type_name -> pb.IndexNameIntegerLiteral
	109, // 195: pb.Argument.arithmetic_expression:type_name -> pb.ArithmeticExpression
	120, // 196: pb.QualifiedDataNameIntegerLiteral.qualified_data_name:type_name -> pb.QualifiedDataName
	163, // 197: pb.QualifiedDataNameIntegerLiteral.integer_literal:type_name -> pb.IntegerLiteral
	143, // 198: pb.IndexNameIntegerLiteral.index_name:type_name -> pb.IndexName
	163, // 199: pb.IndexNameIntegerLiteral.integer_literal:type_name -> pb.IntegerLiteral
	121, // 200: pb.QualifiedDataName.f1:type_name -> pb.QualifiedDataNameFormat1
	122, // 201: pb.QualifiedDataName.f2:type_name -> pb.QualifiedDataNameFormat2
	123, // 202: pb.QualifiedDataName.f3:type_name -> pb.QualifiedDataNameFormat3
	124, // 203: pb.QualifiedDataName.f4:type_name -> pb.QualifiedDataNameFormat4
	138, // 204: pb.QualifiedDataNameFormat1.data_name:type_name -> pb.DataName
	137, // 205: pb.QualifiedDataNameFormat1.condition_name:type_name -> pb.ConditionName
	125, // 206: pb.QualifiedDataNameFormat1.in_datas:type_name -> pb.InData
	130, // 207: pb.QualifiedDataNameFormat1.in_tables:type_name -> pb.InTable
	126, // 208: pb.QualifiedDataNameFormat1.in_file:type_name -> pb.InFile
	148, // 209: pb.QualifiedDataNameFormat2.paragraph_name:type_name -> pb.ParagraphName
	128, // 210: pb.QualifiedDataNameFormat2.in_section:type_name -> pb.InSection
	158, // 211: pb.QualifiedDataNameFormat3.text_name:type_name -> pb.TextName
	129, // 212: pb.QualifiedDataNameFormat3.in_library:type_name -> pb.InLibrary
	126, // 213: pb.QualifiedDataNameFormat4.in_file:type_name -> pb.InFile
	138, // 214: pb.InData.data_name:type_name -> pb.DataName
	141, // 215: pb.InFile.file_name:type_name -> pb.FileName
	147, // 216: pb.InMnemonic.mnemonic_name:type_name -> pb.MnemonicName
	155, // 217: pb.InSection.section_name:type_name -> pb.SectionName
	145, // 218: pb.InLibrary.library_name:type_name -> pb.LibraryName
	111, // 219: pb.InTable.table_call:type_name -> pb.TableCall
	159, // 220: pb.AlphabetName.cobol_word:type_name -> pb.CobolWord
	156, // 221: pb.AssignmentName.system_name:type_name -> pb.SystemName
	150, // 222: pb.BasisName.program_name:type_name -> pb.ProgramName
	159, // 223: pb.CdName.cobol_word:type_name -> pb.CobolWord
	159, // 224: pb.ClassName.cobol_word:type_name -> pb.CobolWord
	156, // 225: pb.ComputerName.system_name:type_name -> pb.SystemName
	159, // 226: pb.ConditionName.cobol_word:type_name -> pb.CobolWord
	159, // 227: pb.DataName.cobol_word:type_name -> pb.CobolWord
	156, // 228: pb.EnvironmentName.system_name:type_name -> pb.SystemName
	159, // 229: pb.FileName.cobol_word:type_name -> pb.CobolWord
	159, // 230: pb.IndexName.cobol_word:type_name -> pb.CobolWord
	156, // 231: pb.LanguageName.system_name:type_name -> pb.SystemName
	159, // 232: pb.LibraryName.cobol_word:type_name -> pb.CobolWord
	159, // 233: pb.LocalName.cobol_word:type_name -> pb.CobolWord
	159, // 234: pb.MnemonicName.cobol_word:type_name -> pb.CobolWord
	159, // 235: pb.ParagraphName.cobol_word:type_name -> pb.CobolWord
	163, // 236: pb.ParagraphName.integer_literal:type_name -> pb.IntegerLiteral
	148, // 237: pb.ProcedureName.paragraph_name:type_name -> pb.ParagraphName
	155, // 238: pb.ProcedureName.section_name:type_name -> pb.SectionName
	166, // 239: pb.ProgramName.non_numeric_literal:type_name -> pb.NonNumericLiteral
	159, // 240: pb.ProgramName.cobol_word:type_name -> pb.CobolWord
	159, // 241: pb.RoutingName.cobol_word:type_name -> pb.CobolWord
	159, // 242: pb.ScreenName.cobol_word:type_name -> pb.CobolWord
	159, // 243: pb.SectionName.cobol_word:type_name -> pb.CobolWord
	163, // 244: pb.SectionName.integer_literal:type_name -> pb.IntegerLiteral
	159, // 245: pb.SystemName.cobol_word:type_name -> pb.CobolWord
	159, // 246: pb.SymbolicCharacter.cobol_word:type_name -> pb.CobolWord
	159, // 247: pb.TextName.cobol_word:type_name -> pb.CobolWord
	21,  // 248: pb.Literal.type:type_name -> pb.Literal.Type
	162, // 249: pb.Literal.numeric_literal:type_name -> pb.NumericLiteral
	161, // 250: pb.Literal.boolean_literal:type_name -> pb.BooleanLiteral
	166, // 251: pb.Literal.non_numeric_literal:type_name -> pb.NonNumericLiteral
	164, // 252: pb.Literal.figurative_constant:type_name -> pb.FigurativeConstant
	22,  // 253: pb.NumericLiteral.type:type_name -> pb.NumericLiteral.Type
	23,  // 254: pb.FigurativeConstant.type:type_name -> pb.FigurativeConstant.Type
	160, // 255: pb.FigurativeConstant.literal:type_name -> pb.Literal
	160, // 256: pb.AlphabetClause.Also.alsos:type_name -> pb.Literal
	160, // 257: pb.AlphabetClause.AlphabetLiteral.literal:type_name -> pb.Literal
	160, // 258: pb.AlphabetClause.AlphabetLiteral.through:type_name -> pb.Literal
	171, // 259: pb.AlphabetClause.AlphabetLiteral.alsos:type_name -> pb.AlphabetClause.Also
	172, // 260: pb.AlphabetClause.AlphabetLiterals.values:type_name -> pb.AlphabetClause.AlphabetLiteral
	3,   // 261: pb.AlphabetClause.Alphanumeric.type:type_name -> pb.AlphabetClause.Alphanumeric.Type
	159, // 262: pb.AlphabetClause.Alphanumeric.cobol_word:type_name -> pb.CobolWord
	173, // 263: pb.AlphabetClause.Alphanumeric.values:type_name -> pb.AlphabetClause.AlphabetLiterals
	4,   // 264: pb.AlphabetClause.National.type:type_name -> pb.AlphabetClause.National.Type
	160, // 265: pb.AlphabetClause.National.ccs_version:type_name -> pb.Literal
...
func file_cobol_proto_init() {
	...
	file_cobol_proto_msgTypes[150].OneofWrappers = []interface{}{
